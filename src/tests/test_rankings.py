...
@pytest.mark.parametrize(
    ...
    [
        (tree_01, [("blue", 2), ("green", 1), ("yellow", 1)]),
        (tree_02, [("orange", 3), ("red", 3), ("green", 2), ("pink", 2), ("blue", 1),],),
        (
            tree_03,
            [
                ("red", 2),
...
@pytest.mark.parametrize(
    "testing_tree, exp_result",
    [
        (tree_01, [("yellow", 3), ("blue", 2), ("green", 1)]),
        (tree_02, [("blue", 5), ("red", 3), ("green", 2), ("orange", 2), ("pink", 1),],),
        (
            tree_03,
            [
                ("black", 1),
...
@pytest.mark.parametrize(
    "testing_tree, exp_result",
    [
        (tree_01, [("green", 400), ("yellow", 300), ("blue", 150)]),
        (
            tree_02,
            [
                ("blue", 750),
